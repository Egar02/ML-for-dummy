...
**1. Возвращаемся в терминал, переходим в папку с клонированным репозиторием**
...
- На левой панели инструментов открываем вкладку Explorer.
...
- После открытия файла листаем в его конец.
- Добавляем в самый его конец (с новой строки) следующий текст:
...
**6. Отправляем изменения на удалённый репозиторий**
